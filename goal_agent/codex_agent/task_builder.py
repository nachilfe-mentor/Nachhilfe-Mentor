    ...
    if rec.recommendation_type == "create_practice_asset":
        ...
        if "guided writing" in rec_text or any(term in rec_text for term in GUIDED_WRITING_TERMS):
            return CodingTask(
                ...
                goal=(
                    ...
                    "  Do one explicit improvement pass after the first working draft. Tighten the learning task, wording, and usefulness. "
                    "  Layout must be airy and easy to scan: use generous padding and margin between sections (min 1.5rem), "
                    "  never stack multiple content blocks with less than 1rem gap, and avoid walls of text — break content into clearly "
                    "  separated cards or sections. Mobile and desktop should feel spacious, not cramped. "
                    "  Then write lernmaterialien/entwuerfe/<slug>-qa.md with:\n"
        ...
        return CodingTask(
            ...
            goal=(
                ...
                "  and educational usefulness. Layout must be airy and easy to scan: use generous padding and margin between sections "
                "  (min 1.5rem), never stack content blocks with less than 1rem gap, and avoid walls of text. "
                "  Then write lernmaterialien/entwuerfe/<slug>-qa.md with:\n"
